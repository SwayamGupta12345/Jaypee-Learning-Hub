    ...
    <div class="ap_container">
        ...
        <form method="POST" onsubmit="return confirmDeletion()">
            <div class="form-group">
                ...
                <select id="sem" name="sem" class = "select-op" onchange="this.form.submit()" required>
            ...
            <?php if ($selectedSemester): ?>
                <div class="form-group">
                    ...
                    <select id="subjectSelect" name="id" class = "select-op" required>
                        <option value="" class = "select-op">Select a subject</option>
                        <?php foreach ($subjects as $subject): ?>
                            <option class = "select-op" value="<?php echo htmlspecialchars($subject); ?>"><?php echo htmlspecialchars($subject); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            <?php endif; ?>
