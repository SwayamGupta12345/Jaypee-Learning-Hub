...
<div class="ap_container">
    ...
    <form method="POST" id="EditForm" class="form" onsubmit="return confirmSubmission();">
        ...
        <div class="form-group">
            ...
            <select name="subject" id="subject" class = "select-op" required>
        ...
        <div id="dataDetails" style="display:none;">
            <div class="form-group">
                ...
                <input type="text" id="description" name="description" class="form-control select-op">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="displaysem" name="displaysem" min="1" max="8" class="form-control select-op">
            </div>
        </div>
